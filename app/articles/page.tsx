    ...
    <div className="min-h-screen py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl lg:text-5xl font-bold text-black mb-4">모든 글</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            개발과 관련된 모든 글들을 확인해보세요. 프론트엔드, 백엔드, DevOps 등 다양한 주제의 글을 찾을 수 있습니다.
          </p>
        </div>
        ...
        {posts.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-600 mb-2">아직 글이 없습니다</h3>
            <p className="text-gray-500 mb-6">곧 새로운 글들이 추가될 예정입니다.</p>
